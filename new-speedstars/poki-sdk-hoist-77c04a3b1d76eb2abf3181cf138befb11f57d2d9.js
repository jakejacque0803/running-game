( () => {
    ...
    ( () => {
        ...
        function w() {
            ...
            L = "chrome_extension" === w ? "poki_chrome_extension" : "edge_extension" === w ? "poki_edge_extension" : l ? "tiktok" : u ? "snapchat" : "android_app" === A ? "poki_android_app" : "web_app_manifest" === w ? "pwa" : B || (N || (R || (!d && w ? w : j || (M && S ? f(p(S)) || S : "g" === O ? "google" : "ytv" === O ? "youtube" : d || E || I || _ || x || P || T || C ? !d && E && /^\d+$/.test(E) ? "direct" : "" === e && d ? "unknown" : e || "unknown" : "direct"))));
            var U, F = h.has(L) || !!(E || I || _ || x || P || T || C) || "cpc" === b || "rtb-cpm" === b || "ppc" === b || "paid" === b, V = (s || "").toLowerCase(), G = !g.has(V) && (v.has(L) || /^com\.google\.android\.googlequicksearchbox$/.test(V) || function(e) {
                return /^webcache\.googleusercontent\.com$/.test(e)
            }(V) || !!k && "share" !== b);
            return U = "snapchat" === w ? "cpc" : P && !w ? "organic" : F ? "cpc" : G ? "organic" : g.has(V) ? "oauth" : "pwa" === L || "poki_android_app" === L || d || "social" === b || "email" === b ? "referral" : L ? "unknown" : "direct",
            "direct" === L && "direct" !== U && "unknown" !== U && "referral" !== U && (L = "unknown"),
            h.has(L) && (L = "unknown"),
            "poki" === L && "cpc" === U && (L = "unknown"),
            {
                source: L,
                medium: U
            }
        ...
        const O = /(?:phone|windows\s+phone|ipod|blackberry|(?:android|bb\d+|meego|silk|googlebot) .+? mobile|palm|windows\s+ce|opera mini|avantgo|mobilesafari|docomo|kaios)/i
          , D = /(?:ipad|playbook|android|bb\d+|meego|silk)/i
          , L = /(?:android|bb\d+|meego|silk) .+? mobile/i;
        function M() {
        ...
        const R = B("referrer") || ""
          ...
          , U = {
            ...
            device: "undefined" != typeof navigator && "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1 ? "tablet" : O.test(navigator.userAgent) ? "mobile" : D.test(navigator.userAgent) && !L.test(navigator.userAgent) ? "tablet" : "desktop",
            experiment: B("experiment") || "",
            forceAd: B("force_ad") || !1,
            isPokiIframe: (parseInt(B("site_id"), 10) || 0) > 0,
            isPokiExternal: !!window.isPokiExternal,
            siteID: parseInt(B("site_id"), 10) || 3,
            tag: B("tag") || "",
            versionID: B("game_version_id"),
            debugMode: "true" === B("pokiDebug"),
            logMode: "" !== B("pokiLogging"),
            testVideos: "true" === B("testVideos"),
            referrerParam: R,
            isPlayground: !!window.isPokiPlayground,
            isInspector: "inspector-uploads.poki-user-content.com" === window?.location?.host || document?.referrer?.includes("inspector.poki.dev") || "1" === B("inspector"),
            houseAdsOnly: !1,
            adOverrideMode: !1,
            googlePreview: !!B("google_preview"),
            ccpaApplies: "1" === j || "0" !== j && void 0,
            country: (B("country") || "").toUpperCase(),
            gameID: B("game_id"),
            gdprApplies: (F = (B("country") || "").toUpperCase(),
            C.includes(F)),
            contentGameID: void 0,
            specialCondition: B("special_condition"),
            nonPersonalized: "y" === B("nonPersonalized"),
            familyFriendly: "y" === B("familyFriendly"),
            kioskMode: "y" === B("kioskMode") || !!window?.kioskMode,
            forceBidder: B("force_bidder") || "",
            cloudSaveGames: "y" === B("cloudsavegames"),
            AYMode: N.ON,
            forceStartAY: "y" === B("forceStartAY")
        };
        var F;
        const V = (e, t) => {
            U[e] = t
        ...
        class z {
            static sendMessage(t, n, o=window.parent) {
                ...
                const r = n || {};
                G.gameID && G.versionID && (r.pokifordevs = {
                    game_id: G.gameID,
        ...
        const q = e => {
            ...
            return Object.keys(e).forEach(n => {
                "object" == typeof e[n] ? t = t.concat(q(e[n])) : t.push(e[n])
            }
            ),
            t
        }
        ...
        const Y = e => {
            if ("undefined" == typeof window || "undefined" == typeof fetch)
                return;
            const t = W.getVideoDataAnnotations();
            let {size: n} = e;
        ...
        class te {
            ...
            static track(t, n={}) {
                try {
                    ...
                    if (-1 === X.indexOf(t))
                        throw new TypeError(`Invalid 'event', must be one of ${X.join(", ")}`);
                    if ("object" != typeof o)
                        throw new TypeError("Invalid data, must be an object");
                    const r = W.getVideoDataAnnotations();
                    if (r?.pokiAdServer)
                        switch (t) {
                        case e.tracking.ads.status.started:
                            {
                                const {creativeId: e} = r;
                                W.addVideoDataAnnotations({
                                    houseAdId: e
                                }),
                                o.houseAdId = e;
                                break
                    ...
                    K.log && (Object.keys(o).length ? console.info(`%cPOKI_TRACKER:%c Tracked event '${t}' with data:`, "font-weight: bold", "", o) : console.info(`%cPOKI_TRACKER:%c Tracked event '${t}'`, "font-weight: bold", "")),
                    Z?.({
                        event: t,
                        data: o
                    }),
                    z.sendMessage(e.message.event, {
                        event: t,
                        data: o
                    }),
                    !(G.isPokiIframe || G.isInspector || G.isPlayground || G.isPokiExternal)) {
                        ...
                        te.logToObserver ? te.pushEvent(n, r, i) : (te.eventQueue.push([n, r, i]),
                        te.eventQueue.length > 100 && te.eventQueue.shift())
                    }
                } catch (e) {
                    J("error while tracking event", e)
                }
            }
            ...
            static setupObserver() {
                ...
                }(window.location.pathname, "external", G.contentGameID),
                function() {
                ...
                ee[ee._pokiSessionGlobalName].referrer = G.referrerParam,
                ...
                Q("https://a.poki-cdn.com/t2.js"),
                te.logToObserver = !0; te.eventQueue.length; ) {
                    const [e,t,n] = te.eventQueue.shift();
                    te.pushEvent(e, t, n)
                }
            }
        }
        ...
        const se = []
          ...
          , de = console.error
          , le = ["Audio callback had starved sending audio by"];
        let ue = !1;
        const pe = Math.random().toString(36).substring(2);
        let fe;
        function me() {
            const e = window;
        ...
        function ge(e, t=!0) {
            G.gameID && !G.isPlayground ? ce(t => {
                try {
                    const n = e.message || re(e);
                    se.push({
                        n: e.name,
                        m: n,
                    ...
                    de("%cPOKI:%c failed to log error", "font-weight: bold", "", e)
                }
            }
            ) : t && console.error("%cPOKI:%c game error", "font-weight: bold", "", e)
        }
        function he(e) {
            oe(e.reason) ? ge(e.reason) : ge({
                name: "unhandledrejection",
                message: JSON.stringify(e.reason) || re(e)
            })
        }
        function ye(e) {
            oe(e.error) ? ge(e.error) : ge(e)
        }
        function ve() {
            if (G.gameID && !G.isPlayground && !G.isPokiExternal && G.isPokiIframe && !ue) {
                ue = !0,
                window.addEventListener("unhandledrejection", he),
                window.addEventListener("error", ye);
                try {
                    console.error = (...e) => {
                        const t = re(e);
                        le.some(e => t.includes(e)) || ge({
                            name: "console.error",
                            message: t
                        }, !1),
                        de.apply(console, e)
        ...
        const ke = window.requestAnimationFrame;
        function Ae(e) {
        ...
        class Se {
            ...
            stats() {
                ...
                const e = Math.min(...this.#e)
                  , t = Math.max(...this.#e)
                  , n = Ae(this.#e.reduce( (e, t) => e + t, 0) / this.#e.length);
                let o = Ae(this.#e.slice(1).map( (e, t) => Math.abs(e - this.#e[t])).reduce( (e, t) => e + t, 0) / (this.#e.length - 1));
                return Number.isNaN(o) && (o = 0),
                `${e}|${t}|${n}|${o}`
            }
        }
        const Ee = Math.random().toString(36).substring(2);
        async function Ie() {
        ...
        class _e {
            ...
            static trackSavegames() {
                window.cookieStore && window.cookieStore.getAll && G.gameID && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (_e.collectAndLog(),
                setInterval(_e.collectAndLog, 12e4)))
            }
        }
        const xe = ( () => {
            let e = 0;
        ...
        function Be(e, t={}) {
            return {
                width: t.width || function(e) {
                    const t = Me(e, "border-left-width")
                      , n = Me(e, "border-right-width");
                    return e.clientWidth + t + n
                }(e),
                height: t.height || function(e) {
                    const t = Me(e, "border-top-width")
        ...
        function Ue(e, t, n, o) {
            const r = `.${e}:${t}`
              , i = n.cssText ? function(e) {
                ...
                return Le(document.documentElement, t).map(t => `${t}: ${e.getPropertyValue(t)}${e.getPropertyPriority(t) ? " !important" : ""};`).join(" ")
            }(n, o);
        ...
        async function $e(e, t, n) {
            ...
            try {
                const o = await We(e, n.fetchRequestInit, ({res: e, result: n}) => (t || (t = e.headers.get("Content-Type") || ""),
                function(e) {
                    return e.split(/,/)[1]
                }(n)));
                r = He(o, t)
        ...
        async function Je(e, t) {
            return Ce(e, HTMLCanvasElement) ? async function(e) {
                try {
                    if (e.getContext("2d"))
                        return Re(e.toDataURL())
                } catch {}
            ...
            }(e) : Ce(e, HTMLVideoElement) ? async function(e, t) {
                if (e.currentSrc) {
                ...
                const {poster: n} = e
                  , o = Ke(n);
                return Re(await $e(n, o, t))
            }(e, t) : Ce(e, HTMLIFrameElement) ? async function(e, t) {
                try {
                    if (e?.contentDocument?.body)
                        return await tt(e.contentDocument.body, t, !0)
                } catch {}
                return e.cloneNode(!1)
            }(e, t) : e.cloneNode(Ze(e))
        }
        const Qe = e => "SLOT" === e.tagName?.toUpperCase()
          , Ze = e => null != e.tagName && "SVG" === e.tagName.toUpperCase();
        function Xe(e, t, n) {
            return function(e, t, n) {
                ...
                o.transformOrigin = r.transformOrigin) : Le(e, n).forEach(n => {
                    let i = r.getPropertyValue(n);
                    if ("font-size" === n && i.endsWith("px")) {
                        const e = Math.floor(parseFloat(i.substring(0, i.length - 2))) - .1;
                        i = `${e}px`
                    }
                    Ce(e, HTMLIFrameElement) && "display" === n && "inline" === i && (i = "block"),
                    "d" === n && t.getAttribute("d") && (i = `path(${t.getAttribute("d")})`),
                    o.setProperty(n, i, r.getPropertyPriority(n))
                }
                )
            }(e, t, n),
            Ce(e, HTMLElement) && Ce(t, HTMLElement) && (function(e, t) {
                Ce(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
                Ce(e, HTMLInputElement) && t.setAttribute("value", e.value)
            }(e, t),
            function(e, t) {
        ...
        async function tt(e, t, n) {
            return n || !t.filter || t.filter(e) ? Te(e) ? (et++,
            et % 5 == 0 && await (o = 0,
            e => new Promise(t => {
                setTimeout( () => t(e), o)
            }
            )),
            Promise.resolve(e).then(e => Je(e, t)).then(n => async function(e, t, n) {
                if (Ze(t))
                    return t;
                let o = [];
                return o = Qe(e) && e.assignedNodes ? Pe(e.assignedNodes()) : Ce(e, HTMLIFrameElement) && e.contentDocument?.body ? Pe(e.contentDocument.body.childNodes) : Pe(("shadowRoot"in e ? e.shadowRoot ?? e : e).childNodes),
                0 === o.length || Ce(e, HTMLVideoElement) || await o.reduce( (e, o) => e.then( () => tt(o, n)).then(e => {
                    e && t.appendChild(e)
                }
                ), Promise.resolve()),
                t
            }(e, n, t)).then(n => Xe(e, n, t)).then(e => async function(e, t) {
        ...
        async function st(e, t, n) {
            ...
            const o = function(e, {preferredFontFormat: t}) {
              ...
              , r = function(e) {
                const t = [];
                return e.replace(nt, (e, n, o) => (t.push(o),
                e)),
                t.filter(e => !qe(e))
            }(o);
            return r.reduce( (e, o) => e.then(e => it(e, o, t, n)), Promise.resolve(o))
        }
        async function ct(e, t, n) {
            const o = t.style?.getPropertyValue(e);
            if (o) {
                const r = await st(o, null, n);
        ...
        async function dt(e, t) {
            Te(e) && (await async function(e, t) {
                await ct("background", e, t) || await ct("background-image", e, t),
                await ct("mask", e, t) || await ct("mask-image", e, t)
            }(e, t),
            await async function(e, t) {
                const n = Ce(e, HTMLImageElement)
                  , o = Ce(e, SVGImageElement);
                if ((!n || qe(e.src)) && (!o || qe(e.href.baseVal)))
                    return;
            ...
            await async function(e, t) {
                const n = Pe(e.childNodes).map(e => dt(e, t));
        ...
        async function pt(e, t) {
            ...
            const o = /url\(["']?([^"')]+)["']?\)/g
              , r = (n.match(/url\([^)]+\)/g) || []).map(async r => {
                ...
                We(i, t.fetchRequestInit, ({result: e}) => (n = n.replace(r, `url(${e})`),
                [r, e]))
            }
            );
        ...
        async function mt(e, t) {
            ...
            const n = Pe(e.ownerDocument.styleSheets)
              , o = await async function(e, t) {
                ...
                return e.forEach(n => {
                    if ("cssRules"in n)
                        try {
                            Pe(n.cssRules || []).forEach( (e, r) => {
                                if (e instanceof CSSImportRule) {
                                    let i = r + 1;
                                    const a = ut(e.href).then(e => pt(e, t)).then(e => ft(e).forEach(e => {
                                        try {
                            ...
                            null != n.href && o.push(ut(n.href).then(e => pt(e, t)).then(e => ft(e).forEach(e => {
        ...
        async function yt(e, t={}) {
            ...
            t.skipAutoScale || function(e) {
                (e.width > Ne || e.height > Ne) && (e.width > Ne && e.height > Ne ? e.width > e.height ? (e.height *= Ne / e.width,
                e.width = Ne) : (e.width *= Ne / e.height,
                e.height = Ne) : e.width > Ne ? (e.height *= Ne / e.width,
                e.width = Ne) : (e.width *= Ne / e.height,
                e.height = Ne))
            }(a),
            a.style.width = `${d}`,
        ...
        async function kt(e, t={}, n=5e3) {
            ...
            try {
                ...
                t instanceof Error && "AbortError" === t.name ? ($(`fetchWithTimeout: Fetch aborted for ${e}. Error: ${t.message}`),
                t) : t instanceof Error ? ($(`fetchWithTimeout: Fetch error for ${e}:`, t.message),
                t) : ($(`fetchWithTimeout: An unexpected error occurred for ${e}:`, t),
                new Error("An unexpected fetch error occurred."))
            }
        }
        const At = async e => {
            const {screenshot: t} = e
              , n = await kt("https://api.poki.io/screenshot", {
                method: "POST",
                headers: {
          ...
          , St = async () => {
            const e = e => !["VIDEO", "TEXTAREA", "SCRIPT", "NOSCRIPT", "INPUT", "IFRAME"].includes(e.nodeName) && (!("IMG" === e.nodeName && !e.getAttribute("src")) && !e.classList?.contains(bt().container))
              , t = document.body.style.minWidth
              , n = document.body.style.minHeight;
            document.body.style.minWidth = "100%",
            document.body.style.minHeight = "100%";
            let o = await vt(document.body, {
                filter: e,
        ...
        function zt(e, t, n, o, r, i) {
            ...
            !Rt) {
                const t = .5 * a;
                i.drawImage(Ut, 0, 0, Ut.width, Ut.height, e.x * o, e.y * r, Ut.width * t, Ut.height * t)
            }
        }
        const Kt = "Game tab in background";
        let qt = !0
          , Ht = []
          , Wt = null
          ...
          , tn = []
          , nn = [];
        const on = "desktop" === G.device ? 24 : 12;
        Yt.setAttribute("data-poki-no-playtest", "true"),
        Yt.addEventListener("webglcontextlost", () => {
        ...
        let an = !1
          ...
          , mn = -1;
        function gn(e) {
            if (null === Wt || !Ht.length)
                return;
            const t = Ht[0]
              , n = t.width / Wt.width
              , o = t.height / Wt.height
              , r = (e.clientX - Wt.left) * n
              , i = (e.clientY - Wt.top) * o;
            rn.x = Math.max(0, Math.min(r, t.width)),
            rn.y = Math.max(0, Math.min(i, t.height))
        }
        const hn = e => {
            Ht.length && Yt && gn(e)
        }
          , yn = e => {
            Ht.length && Yt && (0 === e.button ? (an = !0,
            sn = !1) : 2 === e.button ? (cn = !0,
            dn = !1) : 1 === e.button && (an = !0,
            sn = !1,
            cn = !0,
            dn = !1),
            gn(e))
          ...
          , vn = e => {
            0 === e.button ? sn = !0 : 2 === e.button ? dn = !0 : 1 === e.button && (sn = !0,
            dn = !0)
        }
        ;
        function wn() {
            const e = ln;
            e && Yt && $t && ($t.fillStyle = "rgba(255, 255, 255, 0.5)",
            $t.fillRect(0, 0, Yt.width, Yt.height),
            $t.font = "48px Arial",
            $t.fillStyle = "#009cff",
            $t.textAlign = "center",
            $t.fillText(e, Yt.width / 2, Yt.height / 2))
        }
        function bn(e) {
            if (!Yt || !Ht.length)
                return;
            ...
            fn = n,
            mn = o,
            Wt = t.getBoundingClientRect();
            let {width: r, height: i} = Wt;
            0 !== r && 0 !== i || (r = n,
            i = o);
            const a = Nt ? 1024 : "desktop" !== G.device ? 640 : 1280
              , s = Math.min(a / r, a / i, 1);
            r = Math.round(r * s),
            i = Math.round(i * s),
            un = r / n,
            pn = i / o;
            e || Yt.width !== r || Yt.height !== i ? (Yt.width = r,
            Yt.height = i,
        ...
        async function An(e) {
            if (Yt && (Jt || (Jt = document.createElement("canvas"),
            0 === Ht.length ? (Jt.width = Yt.width,
            Jt.height = Yt.height) : (Jt.width = Ht[0].width,
            ...
            Qt)))
                try {
                    ...
                    const t = await (async e => {
                        ...
                        e || t.push("CANVAS");
                        const n = e => !(t.includes(e.nodeName) || "IMG" === e.nodeName && !e.getAttribute("src") || e.classList?.contains(bt().container) || "true" === e.getAttribute?.("data-poki-playtest-skip"))
                    ...
                    if (M())
                        for (let e = 0; e < Ht.length; e++) {
                            if (Ht[e].pokiHtmlDummyCanvas)
                                continue;
                            const t = Ht[e].captureStream(on).getVideoTracks()[0];
                            Xt.push(t),
                            nn.push(null);
                        ...
                        for (let e = 0; e < Ht.length; e++) {
                            ...
                            const r = () => {
                                o.read().then( ({done: t, value: n}) => {
                                    t ? qt = !0 : nn.length <= e ? n.close() : (null !== nn[e] && nn[e].close(),
                                    nn[e] = n,
                                    r())
                                }
                                )
        ...
        function _n(e, t) {
            ...
            En(e),
            bn(!0);
            const n = Yt.captureStream(on);
            let o;
            window.addEventListener("pointermove", hn, {
                capture: !0,
                passive: !0
            }),
            window.addEventListener("pointerdown", yn, {
                capture: !0,
                passive: !0
            }),
            ...
            return r = setInterval( () => {
                if (qt || !Yt || !Ht.length || i > 10)
                    return console.info("%cPOKI_PLAYTEST:%c", "font-weight: bold", "", qt ? "stopped" : "crashed", qt, !Yt, !Ht.length, i),
                    window.removeEventListener("pointermove", hn),
                    window.removeEventListener("pointerdown", yn),
                ...
                if (!kn(Ht)) {
                    ...
                    const e = In();
                    return void (e.length ? En(e) : (console.info("%cPOKI_PLAYTEST:%c no source canvasses found", "font-weight: bold", ""),
                    i++))
                }
                if (!$t && ($t = Yt.getContext("2d"),
                !$t))
                ...
                Jt = null,
                Qt = null),
                $t.clearRect(0, 0, Yt.width, Yt.height);
                for (let e = 0; e < nn.length; e++) {
                    const t = nn[e];
                    null !== t && $t.drawImage(t, 0, 0, t.displayWidth, t.displayHeight, 0, 0, Yt.width, Yt.height)
                }
                Jt && $t.drawImage(Jt, 0, 0, Jt.width, Jt.height, 0, 0, Yt.width, Yt.height),
                zt(rn, an, cn, un, pn, $t),
                an && sn && (an = !1,
                sn = !1),
                cn && dn && (cn = !1,
            ...
            window.addEventListener("visibilitychange", () => {
                ...
                a && clearTimeout(a),
                "visible" === document.visibilityState ? ln === Kt && (ln = "") : (ln = Kt,
                wn(),
                a = setTimeout( () => {
                    qt = !0
                }
        ...
        const xn = new RegExp(`(${["WebView", "(iPhone|iPod|iPad)(?!.*Safari)", "Android.*(;\\s+wv|Version/\\d.\\d\\s+Chrome/\\d+(\\.0){3})", "Linux; U; Android"].join("|")})`,"ig");
        function Pn() {
            window.navigator.userAgent.match(xn) && !G.isPlayground && document.addEventListener("touchmove", e => (e.preventDefault(),
            e.returnValue = !1,
            !1), {
                passive: !1
            })
        ...
        class Cn {
            ...
            this.#d);
            getToken = async () => K.debug ? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiJsVVNGaCtFUjZIaW83VHhjRW9Pc0d1UnJaNU0wNFdQSlpkQ1BBZ09Wcko4Zm5QQTRmK3Zob1E4PSIsImlzcyI6IlBva2kiLCJleHAiOjIzOTIyNzU0NDd9.S7aW6C3Uwe1hINZA1kg20QWTwE0TqKhUkpJUtU16twM" : (this.#l(),
            this.#p());
            login = async () => {
                if (K.debug)
                    return;
                    ...
                    return new Promise(t => {
                        ...
                        const n = o => {
                            if (o.data.type === e.accounts.userToken) {
                                ...
                                if (r)
                                    return $("failed to fetch user token:", r),
                                    void t(null);
                                if (!e)
                                    return void t(null);
                                t(e)
        ...
        function Mn(t) {
            ...
            if (n?.type !== e.message.scoreUpdate)
                return;
            const o = Ln.get(n.message_id);
            o && (Ln.delete(n.message_id),
            o(n.leaderboards),
            0 === Ln.size && (window.removeEventListener("message", Mn),
            Dn = !1))
        }
        let Bn = 0;
        function Nn() {
        ...
        const jn = class {
            ...
            init = (t={}) => {
                ...
                this.#E)
                    return J("PokiSDK.init() called more than once"),
                    this.#E;
                t[Rn] && t[Rn]( (t, n) => async function(t, n) {
                    const o = {
                        time_on_page: performance.now(),
                        p4d_version_id: G.versionID,
                        sdk_version: "f50ff22df08006dbecfd5bf90aad960965a2b93f"
                    };
                    Dn || (Dn = !0,
                    window.addEventListener("message", Mn));
                    const r = (On++).toString(36);
                    return z.sendMessage(e.message.sendScore, {
                        data: {
                            leaderboard: t,
                            score: n,
                            meta: o,
                ...
                window.addEventListener("pointerdown", this.#I),
                ...
                return this.#E = new Promise(n => {
                    this.__monetization.init({
                        onReady: () => {
                            B("preroll") && this.__monetization.forcePreroll(),
                            n()
                        }
                        ,
                        ...t
                    ...
                    this.#_(),
                    G.isInspector && this.#x(),
                    document.location.search.length <= 1 && z.sendMessage(e.message.sendInspectorEvent, {
                        event: "bad-behavior",
                        data: {
                            behavior: "rewrite_query_params"
                        }
                    }),
                    z.sendMessage(e.message.sdkDetails, {
                        version: "f50ff22df08006dbecfd5bf90aad960965a2b93f"
                    })
                }
                ),
                this.#E
                ...
                window.addEventListener("message", async t => {
                    if ("pokiGenerateScreenshot" === t.data.type)
                        (async t => {
                            ...
                            z.sendMessage(e.message.sendGameScreenshot, {
                                data: r
                            })
                        }
                        )(t.data);
                        ...
                        (async () => {
                            const t = await St();
                            z.sendMessage(e.message.sendGameRawScreenshot, {
                                data: {
                                    screenshot: t
                                }
                            })
                        ...
                        const n = await At(t.data);
                        z.sendMessage(e.message.sendUploadScreenshot, {
                            data: {
                                screenshot: n
                            }
                        })
            ...
            #x = () => {
                if (window.addEventListener("message", async t => {
                    if ("pokiInspectorAllowCommercialBreak" === t.data.type && (V("adOverrideMode", !0),
                    V("houseAdsOnly", !0)),
                    "pokiInspectorDisallowCommercialBreak" === t.data.type && (V("adOverrideMode", !1),
                    V("houseAdsOnly", !1)),
                    "pokiInspectorRequestCookies" === t.data.type && Ie().then(t => {
                        z.sendMessage(e.message.sendInspectorCookies, {
                            data: {
                                cookies: t
                            }
                        }),
                        z.sendMessage(e.message.sendInspectorEvent, {
                            event: "cookies",
                            data: {
                                cookies: t
                            }
                ...
                "desktop" !== G.device)
                    try {
                        const t = t => {
                            const n = console[t];
                            console[t] = (...o) => {
                                z.sendMessage(e.message.sendInspectorConsole, {
                                    data: {
                                        level: t,
                                        args: re(o)
                                    }
            ...
            setDebug = (t=!0) => {
                ...
                const {hostname: n} = window.location;
                n.endsWith("poki-gdn.com") || n.endsWith("gdn.poki.com") ? t && te.track(e.tracking.debugTrueInProduction) : (K.debug = t,
                K.log = t ?? K.log,
                t ? function() {
                    if (ue) {
                        ue = !1,
                        window.removeEventListener("unhandledrejection", he),
                        window.removeEventListener("error", ye);
                        try {
                            console.error = de
                        } catch {}
                    }
            ...
            gameplayStart = t => {
                ...
                if (setTimeout( () => {
                    let r;
                    performance.now() - Nn() < 5e3 && (r = this.#h);
                    const i = {
                        ...t,
                        fps: this.#g.stats(),
                        badEvents: n,
                    ...
                    o && (i.bot = 1),
                    te.track(e.tracking.screen.gameplayStart, i)
                }
                , 0),
                clearTimeout(this.#m),
                this.#m = setTimeout( () => {
                    window.addEventListener("pointermove", this.#T),
                    document.addEventListener("keydown", this.#T)
                }
                , 6e5),
                this.#y && (this.#y > performance.now() - 50 && this.#v++,
                this.#y = 0),
                !this.#S && G.isPokiIframe) {
                    this.#S = !0;
                    try {
                        const e = 400 * Math.random() - 200 + 500
                          , t = crypto.getRandomValues(new Uint8Array(e))
                          , n = btoa(String.fromCharCode.apply(null, t));
                        fetch(`https://games.poki.com/savegame?game=${G.gameID}&version=${G.versionID}&gameplay=${crypto.randomUUID()}&device=${G.device}&country=${G.country}${o ? "&bot=1" : ""}`, {
                            method: "POST",
                            mode: "no-cors",
                            body: n
                        }).catch( () => {}
            ...
            gameplayStop = t => {
                ...
                this.#P() ? $("PokiSDK.gameplayStart() ignored because of too many events") : (this.#f = !1,
                te.track(e.tracking.screen.gameplayStop, {
                    ...t,
                    fps: this.#g.stats()
                }),
                clearTimeout(this.#m),
                window.removeEventListener("pointermove", this.#T),
            ...
            openExternalLink = t => {
                ...
                z.sendMessage(e.message.openExternalLink, {
                    params: {
                        url: t
                    }
                })
            ...
            customEvent = (t, n, o={}) => {
                ...
                "game" === t && "segment" === n && o.segment || te.track(e.tracking.custom, {
                    eventNoun: t,
                    eventVerb: n,
                    eventData: o
            ...
            commercialBreak = t => new Promise(n => {
                ...
                "977b60eb-ff81-4c3a-895b-b585410d6c0d" === G.gameID)
                    return void n();
                if (this.#P())
                ...
                this.__runVideoAd({
                    ...
                    onStart: () => {
                        if (this.#w++,
                        window.pokiMeasureBuildin && window.PokiSDK.measure("midroll", this.#w),
                        "function" == typeof t)
                            try {
                                t()
                            } catch (e) {
            ...
            rewardedBreak = t => new Promise(n => {
                ...
                if ("function" == typeof t)
                    ...
                    const e = t?.size || be.SMALL;
                    e === be.SMALL ? r = 1 : e === be.MEDIUM ? r = 2 : e === be.LARGE && (r = 3)
                }
                setTimeout( () => {
                    this.__runVideoAd({
            ...
            shareableURL = (t={}) => new Promise( (n, o) => {
                ...
                if (G.isPokiIframe || G.isInspector) {
                    ...
                    n(`${o}?${r.toString()}`),
                    z.sendMessage(e.message.setPokiURLParams, {
                        params: t
                    })
                } else
            ...
            movePill = (e, t) => {
                ...
                "number" == typeof e && "number" == typeof t ? this.__monetization.moveDebugMobilePill ? this.__monetization.moveDebugMobilePill(e, t) : window?.top?.postMessage({
                    type: "pokiMessageSetMobileNavPosition",
                    content: {
                        topPercent: e,
                        topPx: t
                    }
                }, "*") : $("PokiSDK.movePill() called with invalid parameters", e, t)
            }
            ;
            getURLParam = e => B(`gd${e}`) || B(e);
            captureError = e => {
            ...
            Et());
            showLeaderboard = t => {
                z.sendMessage(e.message.showLeaderboard, {
                    data: {
            ...
            enableEventTracking = e => {
                ...
                G.isPlayground || G.isPokiIframe || G.isInspector || document?.referrer?.includes("games.poki.com") || te.setupObserverWithCMP(e || 0)
            }
            ;
                  ...
                  , d = o => {
                    setTimeout( () => {
                        if (o?.type === e.ads.limit || o?.type === e.ads.busy || o?.type === e.ads.stopped)
                            return void a(!1);
                        if (s === n || this.#A)
                            return W.dispatchEvent(e.ads.startTimer, {
                                overwriteTimeBetweenAds: r
                            }),
                            void a(!!o?.rewardAllowed);
                        const l = W.getVideoDataAnnotations();
                        if ("poki" === l?.bidder)
                            return W.dispatchEvent(e.ads.startTimer, {
                                overwriteTimeBetweenAds: r
                            }),
        ...
        function Fn(e) {
            ...
            return K.debug || (t = G.isPokiIframe ? `/21682198607/${G.device}_ingame_${e}/${G.siteID}_${G.device}_ingame_${e}` : G.isPokiExternal ? `/21682198607/external_${G.device}_display_platform` : `/21682198607/external_${G.device}_display_ingame/external_${G.device}_ingame_${e}`),
            t
        }
        const Vn = () => {
            ...
            return kt(`https://devs-api.poki.com/gameinfo/@sdk?href=${encodeURIComponent(`${window.location.protocol}//${window.location.host}${e}${window.location.search}`)}&referrer=${t}`, {
                method: "GET",
                headers: {
                    "Content-Type": "text/plain"
                }
        ...
        function Gn() {
            ...
            e?.removeEventListener("pointerdown", Gn),
            t?.removeEventListener("pointerdown", Gn),
        ...
        function Kn({gameTitle: e, rejectCallback: t, resolveCallback: n}) {
            ...
            async function() {
                ...
                function({rejectCallback: e, resolveCallback: t}) {
                    ...
                    r && ["pointerdown", "pointerup", "pointermove", "click", "mousedown", "mouseup", "mousemove", "touchstart", "touchend", "touchmove", "contextmenu", "dragstart"].forEach(e => r.addEventListener(e, zn))
                }({
                    rejectCallback: t,
                    resolveCallback: n
                })
        ...
        let Zn = !1;
        try {
            "1" === localStorage.getItem("poki_pbf") ? Zn = !0 : G.isPlayground || "GB" === G.country || localStorage.setItem("poki_pbf", "1")
        } catch {}
        function Xn() {
            if (void 0 === window.MediaRecorder)
                return;
            let e = 'video/webm;codecs="vp9"';
            return ("undefined" != typeof navigator && /(iPad|iPhone|iPod)/gi.test(navigator.userAgent) || Nt || M()) && (e = 'video/mp4;codecs="avc1.42000d"'),
        ...
        try {
            ...
            ;
            G.gameID && !G.isPlayground && !G.isPokiExternal && G.isPokiIframe && (e("log"),
            e("info"),
            e("warn"),
            e("error"))
        } catch {}
        ...
        function lo(t, n, o) {
            ...
            r && (no = new WebSocket("wss://playtest-recorder.poki.io/ws"),
            ...
            no.addEventListener("open", () => {
                if (!no)
                    return;
                if (no.readyState === no.OPEN) {
                    let e;
                    try {
                        const t = document.createElement("canvas")
                          , n = {
                ...
                i.addEventListener("dataavailable", e => {
                    e.data.size > 0 && no && no.readyState === no.OPEN && no.send(e.data)
                }
                ),
                i.start(250);
                const c = {};
                ...
                const l = setInterval( () => {
                    ...
                    d && e.length > 0 && no && no.readyState === no.OPEN && no.send(JSON.stringify({
                        type: "keyboard",
                        offset: s(),
                        keys: c
                    })),
                ...
                ,
                null !== to && (to.forEach(e => {
                    eo(e.event, e.timeMs)
                }
                ),
                to = null),
                fe = e => {
                    no && no.readyState === no.OPEN && no.send(JSON.stringify({
                        type: "error",
                        offset: s(),
                        error: e
                    }))
                ...
                ;
                W.addEventListener(e.playtest.startVideo, u);
                const p = () => {
                    Sn("")
                }
                ;
                W.addEventListener(e.playtest.stopVideo, p);
                const f = new Se(1)
                  , m = setInterval( () => {
                    no && no.readyState === no.OPEN && no.send(JSON.stringify({
                        type: "fps",
                ...
                , 1e3);
                no.addEventListener("close", t => {
                    console.info("%cPOKI_PLAYTEST:%c websocket closed", "font-weight: bold", "", t),
                    eo = () => {}
                    ,
                    W.removeEventListener(e.playtest.startVideo, u),
                    W.removeEventListener(e.playtest.stopVideo, p),
                    clearInterval(l),
                    clearInterval(m),
                    i.stop(),
                    qt = !0,
        ...
        Z = function(t) {
            ...
            Wn = n,
            t.event === e.tracking.screen.gameLoadingFinished ? oo = performance.now() : t.event === e.tracking.screen.gameplayStart && function(e) {
                Hn = e
            }(performance.now()),
            ro.includes(t.event))
                try {
        ...
        function uo(t) {
            const n = function(e) {
                ...
                if (!e.playtestRecord)
                    return !1;
                if (e.playtestVersion && e.playtestVersion !== G.versionID)
                    return !1;
                if (e.playtestNewUser && Zn)
                    return !1;
                const t = "desktop" !== G.device;
                if ("desktop" === e.playtestDeviceCategory && t)
                    return !1;
                if ("mobile" === e.playtestDeviceCategory && !t)
                    return !1;
                if (["GB", "NL", "CA"].includes(G.country))
                    return !1;
                const n = navigator;
            ...
            if (n && o && !r) {
                ...
                new Promise( (e, t) => {
                    ...
                    const a = setInterval( () => {
                        ...
                        if (!function() {
                            ...
                            t !== r && (r = t,
                            i = s),
                            (oo && s - oo > 1e4 || s - i > 1e4) && (te.track(e.tracking.playtest.noCanvas),
                        ...
                        if (c.length) {
                            ...
                            try {
                                lo(c, o, t.playtestRequestID)
                            } catch {}
                        }
                        s > n && (te.track(e.tracking.playtest.notLoaded),
                        clearInterval(a),
                ...
                if (r || function(e) {
                    ...
                    if (!e.metrictestID)
                        return !1;
                    if (e.metrictestVersion && e.metrictestVersion !== G.versionID)
                        return !1;
                    const t = "desktop" !== G.device;
                    return !("desktop" === e.metrictestDeviceCategory && t || "mobile" === e.metrictestDeviceCategory && !t)
                }(t)) {
                    const n = Qn(t);
        ...
        function ko(e, t) {
            if (e) {
                ...
                "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? po(e, t) : void 0
            }
        }
        var Ao = mo(function e(t) {
            fo(this, e),
            this.p = new Promise(t)
        });
        Ao.__typeson__type__ = "TypesonPromise",
        "undefined" != typeof Symbol && Object.defineProperty(Ao.prototype, Symbol.toStringTag, {
            get: function() {
                return "TypesonPromise"
            }
        }),
        Ao.prototype.then = function(e, t) {
            var n = this;
            return new Ao(function(o, r) {
                n.p.then(function(t) {
                    o(e ? e(t) : t)
                }).catch(function(e) {
        ...
        ;
        var So = Object.hasOwn
          , Eo = Object.getPrototypeOf;
        function Io(e, t) {
            return Co(e) && "function" == typeof e.then && (!t || "function" == typeof e.catch)
        }
        function _o(e) {
        ...
        function xo(e, t) {
            ...
            if (!n)
                return null === t;
            var o = So(n, "constructor") && n.constructor;
        ...
        function Po(e) {
            return !(!e || "Object" !== _o(e)) && (!Eo(e) || xo(e, Object))
        }
        function To(e) {
            if (!e || "Object" !== _o(e))
                return !1;
            var t = Eo(e);
            return !t || xo(e, Object) || To(t)
        }
        function Co(e) {
            return null !== e && "object" === bo(e)
        }
        function Oo(e) {
        ...
        function Lo(e, t) {
            if ("" === t)
                return e;
            if (null === e || "object" !== bo(e))
                throw new TypeError("Unexpected non-object type");
            var n = t.indexOf(".");
            if (-1 !== n) {
                var o = e[Do(t.slice(0, n))];
                return void 0 === o ? void 0 : Lo(o, t.slice(n + 1))
            }
            return e[Do(t)]
        }
        function Mo(e, t, n) {
            ...
            var o = t.indexOf(".");
            return -1 !== o ? Mo(e[Do(t.slice(0, o))], t.slice(o + 1), n) : (e[Do(t)] = n,
            e)
        }
        function Bo(e) {
            return null === e ? "null" : Array.isArray(e) ? "array" : bo(e)
        }
        function No(e, t, n) {
        ...
        var zo = mo(function e(t) {
            ...
            value: function(e, t, n, o) {
                o = yo(yo(yo({}, this.options), o), {}, {
                    stringification: !0
                });
                var r = this.encapsulate(e, null, o);
                return Uo(r) ? JSON.stringify(r[0], t, n) : r.then(function(e) {
            ...
            key: "stringifySync",
            value: function(e, t, n, o) {
                return this.stringify(e, t, n, yo(yo({
            ...
            value: function(e, t, n) {
                return n = yo(yo(yo({}, this.options), n), {}, {
                    parse: !0
                }),
            ...
            value: function(e, t, n) {
                var o = this
                  ...
                  , f = Vo(function(e, t) {
                    return No(Promise.all(t.map(function(e) {
                        return e[1].p
                    })), function(n) {
                        return No(Promise.all(n.map(Vo(function(n) {
                            var o = !1
                              , r = []
                              , i = vo(t.splice(0, 1), 1)
                              , a = vo(i[0], 7)
                  ...
                  , g = function(e, t, n, i, d, l, p) {
                    var f, y = {}, v = bo(t), w = u ? function(o) {
                        var r, a = null !== (r = null != p ? p : i.type) && void 0 !== r ? r : Bo(t);
                        u(Object.assign(null != o ? o : y, {
                            ...
                            awaitingTypesonPromise: xo(t, Ao)
                        }, {
                            type: a
                        }))
                    }
                    : null;
                    if (["string", "boolean", "number", "undefined"].includes(v))
                        return void 0 === t || Number.isNaN(t) || t === Number.NEGATIVE_INFINITY || t === Number.POSITIVE_INFINITY || 0 === t ? (f = i.replaced ? t : h(e, t, i, d, !1, l, w)) !== t && (y = {
                            replaced: f
                        }) : f = t,
                        w && w(),
                        f;
                    if (null === t)
                        return w && w(),
                        t;
                    if (n && !i.iterateIn && !i.iterateUnsetNumeric && t && "object" === bo(t)) {
                        var b = s.indexOf(t);
                        if (-1 !== b)
                            return a[e] = "#",
                            w && w({
                    ...
                    var k, A = Po(t), S = Uo(t), E = (A || S) && (!o.plainObjectReplacers.length || i.replaced) || i.iterateIn ? t : h(e, t, i, d, A || S, null, w);
                    if (E !== t ? (f = E,
                    y = {
                        replaced: E
                    }) : "" === e && xo(t, Ao) ? (d.push([e, t, n, i, void 0, void 0, i.type]),
                    f = t) : S && "object" !== i.iterateIn || "array" === i.iterateIn ? (k = new Array(t.length),
                    y = {
                        clone: k
                    }) : (["function", "symbol"].includes(bo(t)) || "toJSON"in t || xo(t, Ao) || xo(t, Promise) || xo(t, ArrayBuffer)) && !A && "object" !== i.iterateIn ? f = t : (k = {},
                    ...
                    if (i.iterateIn) {
                        var I = function(o) {
                            ...
                            m(i, r, function() {
                                ...
                                xo(a, Ao) ? d.push([r, a, Boolean(n), i, k, o, i.type]) : void 0 !== a && (k[o] = a)
                            })
                        };
                        for (var _ in t)
                            I(_);
                        ...
                        Ro(t).forEach(function(o) {
                            ...
                            m(i, {
                                ...
                                xo(e, Ao) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
                            })
                        }),
                        w && w({
                            endIterateOwn: !0,
            ...
            key: "encapsulateSync",
            value: function(e, t, n) {
                return this.encapsulate(e, t, yo(yo({
                    throwOnBadSyncType: !0
                }, n), {}, {
                    sync: !0
                }))
            ...
            value: function(e, t) {
                ...
                if (!e || "object" !== bo(e) || Array.isArray(e))
                    return i(e);
                var a = e.$types;
                if (!0 === a)
                    return i(e.$);
                if (!a || "object" !== bo(a) || Array.isArray(a))
                    return i(e);
                var s = []
                  , c = {}
                  , d = !0;
                ...
                d = !1);
                var l = function(e, t) {
                    var o, i = vo(null !== (o = n.revivers[e]) && void 0 !== o ? o : [], 1)[0];
                    if (!i)
                ...
                var f, m = function() {
                    ...
                    if (Object.entries(a).forEach(function(e) {
                        ...
                        "#" !== i && [].concat(i).forEach(function(e) {
                            var o;
                            vo(null !== (o = n.revivers[e]) && void 0 !== o ? o : [null, {}], 2)[1].plain && (t.push({
                                keypath: r,
                                type: e
                            }),
                            delete a[r])
                ...
                return xo(m, Ao) ? f = m.then(function() {
                    return e
                    ...
                    if (!d || "$types" !== t) {
                        ...
                        if (p || Po(n)) {
                            ...
                            for (Ro(n).forEach(function(r) {
                                var i = e(t + (t ? "." : "") + Oo(r), n[r], null != o ? o : f, f, r)
                                  , a = function(e) {
                                    return xo(e, Ko) ? f[r] = void 0 : void 0 !== e && (f[r] = e),
                                    e
                                };
                                xo(i, Ao) ? u.push(i.then(function(e) {
                                    return a(e)
                                })) : a(i)
                            }),
                            n = f; s.length; ) {
                ...
                u.length && (f = Ao.resolve(f).then(function(e) {
                    return Ao.all([e].concat(u))
                }).then(function(e) {
                    return vo(e, 1)[0]
                }))),
                Io(f) ? r && o.throwOnBadSyncType ? function() {
                    throw new TypeError("Sync method requested but async result obtained")
                }() : xo(f, Ao) ? f.p.then(p) : f : !r && o.throwOnBadSyncType ? function() {
                    throw new TypeError("Async method requested but sync result obtained")
            ...
            value: function(e, t) {
                var n = this
                  , o = null != t ? t : {}
                  , r = function(e) {
                    Uo(e) ? e.forEach(function(e) {
                        r(e)
                    }) : Ro(e).forEach(function(t) {
                        var r;
                        if ("#" === t)
        ...
        Ko.__typeson__type__ = "TypesonUndefined";
        for (var qo = ["null", "boolean", "number", "string", "array", "object"], Ho = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Wo = new Uint8Array(256), Yo = 0; Yo < 64; Yo++)
            Wo[Ho.codePointAt(Yo)] = Yo;
        var $o = function(e, t, n) {
          ...
          , Jo = function(e, t) {
            ...
            for (var d = new ArrayBuffer(s,t), l = new Uint8Array(d), u = 0; u < n; u += 4)
                o = Wo[e.codePointAt(u)],
                r = Wo[e.codePointAt(u + 1)],
                i = Wo[e.codePointAt(u + 2)],
                a = Wo[e.codePointAt(u + 3)],
                l[c++] = o << 2 | r >> 4,
                l[c++] = (15 & r) << 4 | i >> 2,
                l[c++] = (3 & i) << 6 | 63 & a;
            return d
        ...
        const Qo = {
          ...
          , Zo = {
            bigintObject: {
                test: e => "object" == typeof e && xo(e, BigInt),
                replace: String,
        ...
        const nr = {
            blob: {
                ...
                revive(e) {
                    ...
                    return new Blob([tr(n)],{
                        type: t
                    })
                },
                replaceAsync: e => new Ao( (t, n) => {
                    const o = new FileReader;
                    o.addEventListener("load", () => {
                        t({
                            type: e.type,
                            stringContents: er(o.result)
                        })
                    }
                    ),
        ...
        const or = {
            cryptokey: {
                test: e => "CryptoKey" === _o(e) && e.extractable,
                replaceAsync: e => new Ao(async (t, n) => {
                    let o;
                    try {
        ...
        "undefined" != typeof DOMMatrix && cr(DOMMatrix),
        "undefined" != typeof DOMMatrixReadOnly && cr(DOMMatrixReadOnly);
        const dr = {};
        function lr(e) {
        ...
        "undefined" != typeof DOMPoint && lr(DOMPoint),
        "undefined" != typeof DOMPointReadOnly && lr(DOMPointReadOnly);
        const ur = {
            domquad: {
                test: e => "DOMQuad" === _o(e),
                replace: e => ({
        ...
        "undefined" != typeof DOMRect && fr(DOMRect),
        "undefined" != typeof DOMRectReadOnly && fr(DOMRectReadOnly);
        const mr = {
            error: {
                test: e => "Error" === _o(e),
        ...
        [TypeError, RangeError, SyntaxError, ReferenceError, EvalError, URIError].forEach(e => hr(e)),
        "undefined" != typeof AggregateError && hr(AggregateError),
        "function" == typeof InternalError && hr(InternalError);
        const yr = {
            file: {
                test: e => "File" === _o(e),
                replace(e) {
                ...
                revive: ({name: e, type: t, stringContents: n, lastModified: o}) => new File([tr(n)],e,{
                    type: t,
                    lastModified: o
                }),
                replaceAsync: e => new Ao(function(t, n) {
                    const o = new FileReader;
          ...
          , wr = {
            imagebitmap: {
                test: e => "ImageBitmap" === _o(e) || e && e.dataset && "ImageBitmap" === e.dataset.toStringTag,
                replace(e) {
                    const t = document.createElement("canvas");
          ...
          , Sr = {
            IntlCollator: Ar,
            IntlDateTimeFormat: {
                test: e => xo(e, Intl.DateTimeFormat),
                replace: e => e.resolvedOptions(),
                revive: e => new Intl.DateTimeFormat(e.locale,e)
            },
            IntlNumberFormat: {
                test: e => xo(e, Intl.NumberFormat),
                replace: e => e.resolvedOptions(),
          ...
          , Pr = {
            StringObject: {
                test: e => "String" === _o(e) && "object" == typeof e,
                replace: String,
                revive: e => new String(e)
            },
            BooleanObject: {
                test: e => "Boolean" === _o(e) && "object" == typeof e,
                replace: e => e.valueOf(),
                revive: e => new Boolean(e)
            },
            NumberObject: {
                test: e => "Number" === _o(e) && "object" == typeof e,
                replace: Number,
        ...
        "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach(e => function(e) {
            ...
            Or[t.toLowerCase()] = {
                ...
                revive: t => "ArrayBuffer" === _o(t) ? new e(t) : t
            }
        }(e));
        const Dr = {};
        "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach(e => function(e) {
        ...
        const Lr = {
          ...
          , Nr = [Ir, kr, _r, xr]
          , Rr = ([Lr, Br, Pr, Nr, ir, mr, gr, Tr].concat("function" == typeof Map ? Er : [], "function" == typeof Set ? Cr : [], "function" == typeof ArrayBuffer ? Qo : [], "function" == typeof Uint8Array ? Dr : [], "function" == typeof DataView ? rr : [], "undefined" != typeof Intl ? Sr : [], "undefined" != typeof BigInt ? [Xo, Zo] : []),
        [Mr, Lr, Br, Pr, Nr, ir, Tr, br, wr, yr, vr, nr, mr, gr].concat("function" == typeof Map ? Er : [], "function" == typeof Set ? Cr : [], "function" == typeof ArrayBuffer ? Qo : [], "function" == typeof Uint8Array ? Dr : [], "function" == typeof DataView ? rr : [], "undefined" != typeof crypto ? or : [], "undefined" != typeof BigInt ? [Xo, Zo] : [], "undefined" != typeof DOMException ? ar : [], "undefined" != typeof DOMRect ? pr : [], "undefined" != typeof DOMPoint ? dr : [], "undefined" != typeof DOMQuad ? ur : [], "undefined" != typeof DOMMatrix ? sr : []));
        Rr.concat({
        ...
        function Ur(e, t, n, o, r, i) {
            return Kr(function(e, t) {
                return e << t | e >>> 32 - t
            }(Kr(Kr(t, e), Kr(o, i)), r), n)
        }
        function Fr(e, t, n, o, r, i, a) {
            return Ur(t & n | ~t & o, e, t, r, i, a)
        }
        function Vr(e, t, n, o, r, i, a) {
            return Ur(t & o | n & ~o, e, t, r, i, a)
        }
        function Gr(e, t, n, o, r, i, a) {
            return Ur(t ^ n ^ o, e, t, r, i, a)
        }
        function zr(e, t, n, o, r, i, a) {
            return Ur(n ^ (t | ~o), e, t, r, i, a)
        }
        function Kr(e, t) {
        ...
        try {
            ...
            qr = localStorage.getItem("savegame_idbfs_hash")
        } catch {}
        function Wr(e) {
            if (!qr)
                return e;
            try {
                return e.replace(Hr, qr)
            } catch {
                return e
            }
        }
        ...
        function oi(e) {
            return !e || (!!Xr.includes(e) || !!e.startsWith(Zr))
        }
        function ri(e, t) {
                    ...
                    i.forEach(t => {
                        ...
                        l.onsuccess = o => {
                            ...
                            if (null === l)
                                ...
                                n(a)));
                            (function(e, t, n) {
                                return !("string" != typeof n || ("/data" !== e || "FILE_DATA" !== t || !n.endsWith(".zip") && !n.includes("liveupdate.arc")) && !n.startsWith(Zr))
                            }
        ...
        function ii() {
            ...
            const e = (new zo).register([Rr])
              , t = () => {
                const t = performance.now()
                  , n = Math.ceil((t - ti) / 1e3);
                let o = 0;
                try {
                    o = Number.parseInt(localStorage.getItem(Qr) || "0", 10)
                } catch (e) {
                    $("error getting current playtime", e)
                }
                const r = o + n;
                try {
                    localStorage.setItem(Qr, r.toString())
                } catch (e) {
                    $("error setting current playtime", e)
                }
                ti = t;
                try {
                    const t = {};
                    ...
                    (async function() {
                        if (!("databases"in indexedDB))
                            ...
                            [];
                        const e = await indexedDB.databases();
                        0 === e.length && (console.info("%cPOKI_SAVEGAME:%c No databases found, using IDBDatabaseInfos", "font-weight: bold", "", ei.map(e => e.name)),
                        e.push(...ei));
                        const t = [];
                        return e.forEach(async e => {
                            ni(e.name) || t.push(ri(e.name || "", e.version))
                        }
                        ),
            ...
            function n(e, t) {
                ...
                ei.find(n => n.name === e && n.version === t) || ei.push(n)
            }
            jr(`(${function() {
            ...
            const r = (e, t) => {
                ni(e) ? console.info(`Skip IDB Pulse - DB: ${e}, action: ${t}`) : o()
            }
        ...
        class ci {
            #C = {};
            #O = Un.adTiming;
            #D = new MutationObserver(this.mutationObserved.bind(this));
            #L = ai;
            #M;
            #B = !1;
            init = e => {
                ...
                G.isPokiIframe && setTimeout(_e.trackSavegames, 1e4),
                G.cloudSaveGames && ii(),
                G.kioskMode && document.addEventListener("keydown", e => {
                    "Escape" === e.key && this.postSDKMessage("keydownEscape")
                }
                );
                const n = () => {
                    let e, n = 1;
                    this.#C.playgroundInit = () => {
                        clearTimeout(e),
                        t?.()
                    }
                    ;
                ...
                if (K.debug)
                    return void n();
                Vn().then(e => {
                    if (this.#O = e?.adTiming || Un.adTiming,
                    this.#M = e?.specialConditions || [],
                    "mobile" === G.device ? this.#O = {
                        startAdsAfter: 36e4,
                        timeBetweenAds: 36e4
                    } : "tablet" === G.device ? this.#O = {
                        startAdsAfter: 24e4,
                        timeBetweenAds: 24e4
                    } : this.#O = {
                        startAdsAfter: 12e4,
            ...
            displayAd(e) {
                ...
                if (!t)
                    ...
                    !1;
                const a = t.getAttribute("data-poki-ad-container-id") || we();
                ...
                this.#D.observe(t.parentElement || document.body, {
                    childList: !0
                }),
                this.#D.observe(t, {
                    attributes: !0,
            ...
            postSDKMessage = async (t, n={}) => {
                z.sendMessage(e.message.sendCommand, {
                    event: t,
                    data: n
                }, window.top)
            }
                ...
                case "hoist_videoAd_onStart":
                    {
                        ...
                        if (n) {
                            ...
                            if (!this.#C[t])
                                return;
                            const {onStart: o, position: r} = this.#C[t];
                            o && o(),
                            W.dispatchEvent(e.playtest.startVideo, {
                                position: r
                            }),
                            this.#L = "playing"
                        }
                ...
                case "hoist_videoAd_onFinish":
                    {
                        ...
                        if (n) {
                            ...
                            if (!this.#C[t])
                                return;
                            const {onFinish: r, position: i} = this.#C[t];
                            if (this.#L === si) {
                                if (r)
                                    try {
                            ...
                            W.dispatchEvent(e.playtest.stopVideo),
                            this.#L = ai,
                            delete this.#C[t]
                        }
                        break
